...
public class ProductRepoTest {
	...
	void repoTest() {
		...
		Inventory inv4 = new Inventory(0.5, 2, 0.93, 0.93, 1.90, "m04-01", 1, 1, true, LocalDateTime.now());
		...
		Inventory inv9 = new Inventory(6.90, 10, 12.77, 12.77, 17.96, "m06-03", 10, 9, true, LocalDateTime.now());
		...
		Inventory inv10 = new Inventory(16.20, 6, 29.97, 29.97, 40.28, "m07-01", 1, 2, true, LocalDateTime.now());
